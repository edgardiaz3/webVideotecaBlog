...
def register_request(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'blog/home.html', {"title": "Home", "message": "Error", "errors": ["No pasó las validaciones"]})
...
def login_request(request):
    ...
    if  request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'blog/home.html', {"title": "Home", "message": "Errores!", "errors": ["Revise los datos indicados"]})
